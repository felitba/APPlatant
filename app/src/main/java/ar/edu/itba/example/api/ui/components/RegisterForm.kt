...
fun RegisterForm(
    ...
    var correctAttempt by remember { mutableStateOf(false) }
    ...
    BoxWithConstraints(
        ...
        if (correctAttempt) {
            AlertDialog(
                ...
                title = { Text(stringResource(R.string.registered_succersfully)) },
                text = { Text(stringResource(R.string.registered_succersfully_dialog)) },
                confirmButton = {
                    Button(
                        onClick = {
                            firstName = ""
